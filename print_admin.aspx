<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print_admin.aspx.cs" Inherits="idpicture_page.print_admin" %>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Print</span>
      </div>
      ...
      <div class="tbl">
          <form runat="server">
                <asp:GridView ID="GridView5" runat="server" AutoGenerateColumns="False" DataKeyNames="order_id" OnRowEditing="GridView5_RowEditing" OnRowUpdating="GridView5_RowUpdating" >
                <Columns>
                    ...
                    <asp:BoundField DataField="color" HeaderText="Paper Type" ReadOnly="True" />
