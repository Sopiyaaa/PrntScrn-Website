<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="id_admin.aspx.cs" Inherits="idpicture_page.id_admin" %>
    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">ID Picture</span>
            </div>
        ...
        <div class="tbl">
            <form runat="server">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="order_id" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
                <Columns>
                    ...
                    <asp:BoundField DataField="attire" HeaderText="Attire" ReadOnly="True" />
                    <asp:BoundField DataField="background_color" HeaderText="Background Color" ReadOnly="True" />
                    ...
                    <asp:BoundField DataField="email_address" HeaderText="Email Address" ReadOnly="True" />
