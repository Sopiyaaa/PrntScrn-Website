<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sticker_admin.aspx.cs" Inherits="idpicture_page.sticker_admin" %>
    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">Stickers</span>
            </div>
        ...
        <div class="tbl">
            <form runat="server">
                <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" DataKeyNames="order_id" OnRowEditing="GridView6_RowEditing" OnRowUpdating="GridView6_RowUpdating" >
                <Columns>
